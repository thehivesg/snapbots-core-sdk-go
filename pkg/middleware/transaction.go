...
func (t *TransactionMiddleware) Transaction(next echo.HandlerFunc) echo.HandlerFunc {
	return func(c echo.Context) error {
		...
		err = t.natsClient.Publish("v1.transaction.confirmed", transactionRequestBytes)
		if err != nil {
